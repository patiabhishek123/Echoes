  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#1c120c] text-[#ebdcb9] relative select-none font-sans overflow-hidden pb-10">
      ...
      <div className="flex-1 flex flex-col max-w-5xl mx-auto w-full px-6 pt-6 gap-6 relative z-10">
        ...
        <div className="relative w-full aspect-[2.4/1] border-4 border-[#38251b] rounded-lg overflow-hidden shadow-2xl bg-[#ebdcb9] select-none">
          <ThreeDMap
            selectedNpcId={selectedNpcId}
            setSelectedNpcId={setSelectedNpcId}
            handleAdvanceDay={handleAdvanceDay}
